				...
				<c:when test="${playlist != null}">
					...
					<div class="details">
						...
						<div class="track-name-artist" style="display: inline-block";>
							...
							<audio src="${songno[0].path }${songno[0].song}"
								controls="controls" autoplay></audio>
						</div>
					</div>
