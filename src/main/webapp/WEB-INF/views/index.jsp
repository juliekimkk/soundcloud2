	...
	<nav>
		<div class="container">
			<div class="jumbotron jumbotron-fluid bg-dark" width="90%"
				height="130%" style="border: solid blue";>
				<div class="mainbutton" style="border: solid red";>
					<button onClick="create()" ; type="button"
						class="btn btn-danger btn-sm">Create account</button>
											...
											<div class="col">
												<div class="show_image">
													...
													<img class="show_play_icon"
														src="<c:url value="/assetss/images/play.svg" />" />
		...
		<div class="container">
			<div class="row footer_logo_row">
				<div
					...
					<div class="logo">
						<a href="#"><span>my</span>podcast<img src="images/play.png"
							alt=""></a>
					</div>
				</div>
			</div>
								...
								<a href="episode.html">
									<div
										...
										<div class="latest_title_content">
											<div class="latest_title">Season 4 Episode 48 - A Step
												Further</div>
										</div>
									</div>
								</a>
							...
							<div
								...
								<a href="episode.html">
									<div
										...
										<div class="latest_title_content">
											<div class="latest_title">Season 4 Episode 47 - Deep in
												Crypto</div>
										</div>
									</div>
								</a>
							...
							<div
								...
								<a href="episode.html">
									<div
										...
										<div class="latest_title_content">
											<div class="latest_title">Season 4 Episode 46 - Nothing
												is real</div>
										</div>
									</div>
								</a>
				...
				<div class="col-lg-4">
					...
					<div
						...
						<div class="gallery_item">
							<a class="colorbox" href="resources/images/gallery_1_large.jpg"><img
								src="resources/images/gallery_1.jpg" alt=""></a>
						</div>

						<!-- Gallery Item -->
						<div class="gallery_item">
							<a class="colorbox" href="resources/images/gallery_2_large.jpg"><img
								src="resources/images/gallery_2.jpg" alt=""></a>
						</div>

						<!-- Gallery Item -->
						<div class="gallery_item">
							<a class="colorbox" href="resources/images/gallery_3_large.jpg"><img
								src="resources/images/gallery_3.jpg" alt=""></a>
						</div>

						<!-- Gallery Item -->
						<div class="gallery_item">
							<a class="colorbox" href="resources/images/gallery_4_large.jpg"><img
								src="resources/images/gallery_4.jpg" alt=""></a>
						</div>

						<!-- Gallery Item -->
						<div class="gallery_item">
							<a class="colorbox" href="resources/images/gallery_5_large.jpg"><img
								src="resources/images/gallery_5.jpg" alt=""></a>
						</div>
					...
					<div class="footer_social">
						<ul
							...
							<li><a href="#"><i class="fa fa-instagram"
									aria-hidden="true"></i></a></li>
							<li><a href="#"><i class="fa fa-soundcloud"
									aria-hidden="true"></i></a></li>
